            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('financial_book')?></h3>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text text-right"><?php echo $this->lang->line('ammount'); ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
