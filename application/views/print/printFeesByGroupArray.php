                        ...
                        <div class="row">
                            <div class="col-xs-9 text-left">
                                ...
                                <address>
                                    ...
                                    <?php echo $this->lang->line('guardian_name'); ?>: <?php echo $feearray[0]->guardian_name; ?><br>
                                ...
                                <table class="table table-striped table-responsive" style="font-size: 8pt;">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            //echo json_encode(json_decode($feearray[0]->amount_detail))['1'];
                                            foreach ($feearray as $fee_key => $feeList) {
                                                ...
                                                if (!empty($feeList->amount_detail)) {
                                                    ...
                                                    $fee_description = json_encode($fee_deposits->{"1"}->description);
