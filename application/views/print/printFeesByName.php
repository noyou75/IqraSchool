                    ...
                    <div class="invoice">
                        ...
                        <div class="row">                           
                            <div class="col-xs-6 text-left">
                                ...
                                <address>
                                    ...
                                    <?php echo $this->lang->line('guardian_name'); ?>: <?php echo $student['guardian_name']; ?><br>
                        ...
                        <div class="row">
                            ...
                            if (!empty($feeList)) {
                                ...
                                <h4><?php echo $this->lang->line('notice_receipt'); ?></h4>
                                <?php /*TODO (elwiss):*/  echo $record->description; ?>
                                <?php
                            }
                            ?>
