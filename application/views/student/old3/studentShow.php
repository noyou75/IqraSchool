                                ...
                                <div class="box box-widget widget-user-2">
                                    ...
                                    <div class="box-footer no-padding">
                                        <ul class="list-group list-group-unbordered">
                                          ...
                                          <br>
										<a href="<?php echo site_url('studentfee/addfee/' . $sibling_value->id) ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title=""  style="margin-left: 80px;">
