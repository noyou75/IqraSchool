...
class Studentfee extends Admin_Controller {
    ...
    public function addstudentfee() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            // TODO: (elwiss) 07/27/2021 start work from here
            $json_array = array(
            ...
            //here
            $fees_discount_id = $this->db->query("select fees_discount_id from student_fees_discounts where id = $student_fees_discount_id")->result()[0]->fees_discount_id;
            $this->db->query("insert into student_fees_discounts(student_session_id, fees_discount_id) values ($student_session_id,$fees_discount_id)");
            //end
